...
import nl.joelchrist.shorty.client.GoogleCloudClient
...
@Service
class ShortiesManager(@Autowired private val shortiesRepository: ShortiesRepository, @Autowired private val shortiesClient: GoogleCloudClient) {
    ...
    fun create(uuid: UUID, file: MultipartFile): String =
            file.let { shortiesClient.save(uuid.toString(), file.inputStream, file.contentType).mediaLink }
